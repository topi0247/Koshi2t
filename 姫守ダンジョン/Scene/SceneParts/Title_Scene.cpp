...
void Title_Scene::Init()
{
	...
	title_UI["title_ui"]->Init(L"./UI/UI_Tex/title2.png", D3DXVECTOR2(1000, 420), D3DXVECTOR4(1.0, 1.0, 1.0, 1.0), GrapRect(0.0f, 1.0f, 0.0f, 1.0f));
	title_UI["PUSH_A"]->Init(L"./UI/UI_Tex/start_button.png", D3DXVECTOR2(1299, 264), D3DXVECTOR4(1.0, 1.0, 1.0, 1.0), GrapRect(0.0f, 1.0f, 0.0f, 1.0f));
