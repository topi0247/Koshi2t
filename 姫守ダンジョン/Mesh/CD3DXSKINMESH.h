...
private:
	...
	static ID3D11Buffer* m_pConstantBufferBone;
	...
	HRESULT CreateIndexBuffer(DWORD dwSize1, int* pIndex, ID3D11Buffer** ppIndexBuffer);
public:
	...
	CD3DXSKINMESH();
	~CD3DXSKINMESH();
	static HRESULT Init(HWND hWnd, ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
