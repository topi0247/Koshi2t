...
void Effect::EffectSet()
{
	...
	effect_["magicball"] = LoadEffect((const EFK_CHAR*)L"Effekseer/Effects/魔導士/magicball4.efk");
	effect_["aroow"] = LoadEffect((const EFK_CHAR*)L"Effekseer/Effects/魔導士/aroow.efk");
