...
class ParameterRead
{
	static JobParameter** jobParamList_;		//職業パラメータ格納
	static PrincessParameter* princessParam_;	//姫パラメータ格納
	static EnemyParameter** enemyParamList_;	//敵パラメータ格納

	static int jobCount_;		//職業数
	static int enemyCount_;	//敵の種類数
public:
	ParameterRead();
	~ParameterRead();
	static void SetJobParameter(/*const char* filePath*/);		//職業パラメータ読み込み
	static void SetPricessParameter(/*const char* filePath*/);	//姫パラメータ読み込み
	static void SetEnemyParameter(/*const char* filePath*/);	//敵パラメータ読み込み
